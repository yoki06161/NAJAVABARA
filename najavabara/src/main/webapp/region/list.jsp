...
.card-title {
	...
	<form method="get">
		<table>
			<tr>
				<td><select class="form-select" name="area">
				...
				<td><input type="submit" value="지역별 검색" class="btn btn-primary">
				</td>
			</tr>
		</table>
	</form>
	...
	<div class="d-flex justify-content-between">
		...
		<input type="button" class="btn btn-outline-primary"
			onclick="location.href='write.reg'" value="글쓰기">
	</div>
	<br>
	<%
	...
	<div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
		...
		<div class="col">
			<div class="card">
				...
				<img src="../region/no_image.PNG" class="card-img-top" alt="사진">
				<%} else {%>
