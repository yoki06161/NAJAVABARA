...
<body>
    ...
    <a class="navbar-brand" href="../accidentPost/list.jsp">
 ...
 <%
                    ...
                    String searchInputValue = (searchWord == null || searchWord.equals("null")) ? "" : searchWord;
                    %>
                    <input type="text" name="searchWord" class="form-control" placeholder="제목으로 검색" value="<%= searchInputValue %>">
		...
		<nav aria-label="Page navigation" class="mt-3">
			<ul class="pagination justify-content-center">
				...
				<li class="page-item"><a class="page-link"
					href="list.acc?page=<%=currentPage - 1%>&searchField=<%=searchField%>&searchWord=<%=searchWord%>">이전</a>
				</li>
				<%
				}
				%>
				...
				<li class="page-item <%=(i == currentPage) ? "active" : ""%>">
					<a class="page-link"
					href="list.acc?page=<%=i%>&searchField=<%=searchField%>&searchWord=<%=searchWord%>"><%=i%></a>
				</li>
				<%
				}
				%>
				...
				%>
				<li class="page-item"><a class="page-link"
					href="list.acc?page=<%=currentPage + 1%>&searchField=<%=searchField%>&searchWord=<%=searchWord%>">다음</a>
				</li>
				<%
				}
				%>
		...
		<div class="mt-3">
			<a href="write.acc" class="btn btn-primary">글 쓰기</a> <a
				href="index.jsp" class="btn btn-secondary">홈</a>
		</div>
	</div>
</body>
</html>
